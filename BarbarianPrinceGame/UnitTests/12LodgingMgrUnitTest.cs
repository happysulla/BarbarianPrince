   ...
   public class LodgingMgrUnitTest : IUnitTest
   {
      ...
      public bool Command(ref IGameInstance gi)
      {
         ...
         if (CommandName == myCommandNames[0])
         {
            ...
            ++Utilities.MapItemNum;
            IMapItem merchant= new MapItem(merchantName, 1.0,  false, false,"c77Merchant", "c77Merchant", gi.Prince.Territory, 3, 2, 0);
            ...
            ++Utilities.MapItemNum;
            IMapItem slaveGirl= new MapItem(slaveGirlName, 1.0,  false, false,"c41SlaveGirl", "c41SlaveGirl", gi.Prince.Territory, 0, 0, 0);
            gi.AddCompanion(slaveGirl);
            slaveGirlName = "SlaveGirl" + Utilities.MapItemNum.ToString();
            ++Utilities.MapItemNum;
            slaveGirl= new MapItem(slaveGirlName, 1.0,  false, false,"c41SlaveGirl", "c41SlaveGirl", gi.Prince.Territory, 0, 0, 0);
            gi.AddCompanion(slaveGirl);
         ...
         else if (CommandName == myCommandNames[2]) // Minstrel Playing
         {
            ...
            ++Utilities.MapItemNum;
            IMapItem companion1= new MapItem(miName, 1.0,  false, false,"c10Mercenary", "c10Mercenary", gi.Prince.Territory, 5, 5, 0);
            companion1.Food = 10;
            companion1.Coin = 5;
      ...
      private void AddCompanionMount(IMapItem companion, bool isFreshMount)
      {
         if (true == isFreshMount)
         {
            ...
            string name = "Horse" + Utilities.MapItemNum.ToString();
            ++Utilities.MapItemNum;
            MapItem horse= new MapItem(name, 1.0,  false, false,"MHorse", "MHorse", companion.Territory, 0, 0, 0);
         ...
         else
         {
            string name = "Pegasus" + Utilities.MapItemNum.ToString();
            ++Utilities.MapItemNum;
            MapItem pegasus= new MapItem(name, 1.0,  false, false,"MPegasus", "MPegasus", companion.Territory, 0, 0, 0);
